...
export const formFieldsSchemas: Record<string, Record<string, any>> = {
  ...
  [DOCUMENT_TYPE.powerAttorneyVehicle]: {
    ua: {
      ...
      vehicle: [
        { name: 'vehicleMake', label: 'Марка', type: 'text', required: true },
        { name: 'vehicleModel', label: 'Модель', type: 'text', required: true },
        { name: 'vehicleYear', label: 'Рік випуску', type: 'text', required: true },
        { name: 'vehicleColor', label: 'Колір', type: 'text', required: true },
        { name: 'vehicleVin', label: 'Номер шасі (VIN)', type: 'text', required: true },
        { name: 'vehicleLicensePlate', label: 'Реєстраційний номер', type: 'text', required: true },
        { name: 'vehicleType', label: 'Тип ТЗ', type: 'text', required: true },
        { name: 'vehicleRegistrationCertificate', label: 'Номер свідоцтва про реєстрацію', type: 'text', required: true },
        { name: 'vehicleRegistrationAuthority', label: 'Ким видано свідоцтво', type: 'text', required: true },
        { name: 'vehicleRegistrationDate', label: 'Дата реєстрації', type: 'date', required: true },
      ],
      meta: [
    ...
    en: {
      ...
      vehicle: [
        ...
        { name: 'vehicleYear', label: 'Year of Manufacture', type: 'number', required: true },
        { name: 'vehicleColor', label: 'Color', type: 'text', required: true },
        { name: 'vehicleVin', label: 'Chassis Number (VIN)', type: 'text', required: true },
        { name: 'vehicleLicensePlate', label: 'Registration Number', type: 'text', required: true },
        { name: 'vehicleType', label: 'Vehicle Type', type: 'text', required: true },
        { name: 'vehicleRegistrationCertificate', label: 'Registration Certificate No.', type: 'text', required: true },
        { name: 'vehicleRegistrationAuthority', label: 'Certificate Issuing Authority', type: 'text', required: true },
        { name: 'vehicleRegistrationDate', label: 'Date of Registration', type: 'date', required: true },
      ],
      meta: [
