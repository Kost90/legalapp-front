...
const commonFormFields: Record<string, any> = {
  ua: {
    person: [
      ...
      { name: 'passport', label: 'Паспорт(серія та номер)', type: 'text', required: true },
  ...
  en: {
    person: [
      ...
      { name: 'passport', label: 'Passport(number and series)', type: 'text', required: true },
  ...
  [DOCUMENT_TYPE.consentToSellProperty]: {
    ua: {
      person: [
        ...
        { name: 'passportNumber', label: 'Номер паспорта', type: 'text', required: true },
        { name: 'passportRecordNumber', label: 'Номер запису', type: 'text', required: true },
        { name: 'passportIssueDate', label: 'Дата видачі паспорта', type: 'date', required: true },
    ...
    en: {
      person: [
        ...
        { name: 'passportNumber', label: 'Passport Number', type: 'text', required: true },
        { name: 'passportRecordNumber', label: 'Record Number', type: 'text', required: true },
        { name: 'passportIssueDate', label: 'Date of Issue', type: 'date', required: true },
