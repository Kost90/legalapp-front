...
const HeroIllustration = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    {/* Элементы ввода (появятся первыми) */}
    <motion.g
      transform="translate(40, 50)"
      variants={{
        visible: { transition: { staggerChildren: 0.3 } }, // Замедлили появление полей
      }}
    >
    ...
    {/* Стрелка процесса (появится второй) */}
    <motion.g>
      {/* Линия стрелки (теперь прямая) */}
    ...
    {/* Иконка документа (появится последней, позиция исправлена) */}
